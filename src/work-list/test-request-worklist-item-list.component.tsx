...
interface TestRequestWorklistItemListProps {
...
const TestRequestWorklistItemList: React.FC<
  TestRequestWorklistItemListProps
> = ({
  tests,
...
export default TestRequestWorklistItemList;
