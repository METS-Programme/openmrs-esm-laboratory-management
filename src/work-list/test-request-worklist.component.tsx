...
interface TestRequestWorklistProps {
  from?: string;
}

const TestRequestWorklist: React.FC<TestRequestWorklistProps> = () => {
  ...
  const {
    ...
    itemStatus: TestRequestItemStatusInProgress,
...
export default TestRequestWorklist;
