...
interface TestRequestCompletedItemListProps {
...
const TestRequestCompletedItemList: React.FC<
  TestRequestCompletedItemListProps
> = ({
  tests,
  tableHeaders,
  onSelectionChange,
...
export default TestRequestCompletedItemList;
